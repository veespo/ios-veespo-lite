...
/**
 Get a list of all the targets on which the user has expressed his opinion. The targets are related to a single category. If the user has not never voted, tha callback returns an error.
